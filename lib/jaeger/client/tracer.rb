  ...
  module Client
    class Tracer
      ...
      def start_active_span(operation_name,
        ...
        # make a span
        parent_scope = @scope_manager.active
        parent = child_of || (!ignore_active_scope && parent_scope&.span)
        span = start_span(operation_name, child_of: parent, start_time: start_time, tags: tags)
        ...
        scope.tap do |s|
          if block_given?
            begin
              ...
              s.close if finish_on_close
              @scope_manager.activate_scope(parent_scope)
            end
          end
        end
      end
